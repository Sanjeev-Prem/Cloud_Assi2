...
if __name__ == "__main__":
    ...
    .appName('Prem_cs643_wine_prediction') \
    .getOrCreate()
...
if len(sys.argv) > 3:
    ...
    print(current_dir)
    input_path = os.path.join(current_dir,"buicketwine\data\csv\testdata.csv")
    model_path= os.path.join(current_dir, "buicketwine\data\model\testdata.model")
df = (spark.read
        .format("csv")
        .option('header', 'true')
        .option("sep", ";")
