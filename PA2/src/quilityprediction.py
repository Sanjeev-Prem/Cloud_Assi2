...
if __name__ == "__main__":
    ...
    spark = SparkSession.builder \
        .appName('Prem_CS643_Programming_Assignment_2') \
        .getOrCreate()
    ...
    if len(sys.argv) > 3:
        ...
        input_path = "s3://buicketwine/TrainingDataset.csv"
        valid_path = "s3://buicketwine/ValidationDataset.csv"
        output_path="s3://buicketwine/testmodel.model"
